        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" class="form-inline" action="<c:url value="/dormitoryAdmin?method=search"/>" method="post">
            ...
            <div class="table-responsive">
                ...
                <!-- add框示例（Modal） -->
                <form method="post" action="<c:url value="/dormitoryAdmin?method=save"/>" class="form-horizontal" style="margin-top: 0" role="form"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal" role="form">
                                        <div class="form-group">
                                            <%--@declare id="user_id"--%><label for="user_id" class="col-sm-3 control-label">用户名</label>
                                            <div class="col-sm-9">
                ...
                <!-- update框示例（Modal） -->
                <form method="post" action="<c:url value="/dormitoryAdmin?method=update"/>" class="form-horizontal" style="margin-top: 0px" role="form"
                      id="form_data" style="margin: 20px;">
                ...
                <!-- 删除模态框示例（Modal） -->
                <form method="post" action="<c:url value="/dormitoryAdmin?method=delete"/>"
