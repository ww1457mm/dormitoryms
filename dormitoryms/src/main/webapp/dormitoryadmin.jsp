...
<nav class="navbar navbar-inverse" role="navigation">
    <div class="container-fluid">
        <ul class="nav navbar-nav navbar-left">
            <li>
                <a style="font-size: 26px;">梧州学院宿舍管理系统-宿舍管理员</a>
            </li>
        </ul>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li>
                <a href="<c:url value="/account?method=logout"/>">安全退出</a>
            </li>
        </ul>
    </div>
</nav>
<div class="container-fluid">
    <div class="row">
        ...
        <!--右边内容-->
        <iframe style="width: 81%; height: 600px; border: 0;" src="<c:url value="/absent?method=init"/>"></iframe>
    </div>
</div>
<div class="footer">
    <p class="text-center">
